...
namespace RivetedRunes.Controllers
{
    public class CameraController : MonoBehaviour
    {
        ...
        void HandleMovement()
        {
            ...
            newPos = _currentMoveSpeed * TimeManager.Instance.GetTime(true) * newPos + _target.transform.position;
        ...
        void HandleZoom()
        {
            ...
            if (scroll != 0)
            {
                ...
                newPos = _currentZoomSpeed * TimeManager.Instance.GetTime(true) * newPos + _target.transform.position;
